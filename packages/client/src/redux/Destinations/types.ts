...
export enum DestinationsActionCategory {
    ...
    FETCH_DESTINATION = '@destination/LOAD_DESTINATION',
}
export enum DestinationsActionTypes {
    ...
    FETCH_DESTINATION_SUCCESS = '@destination/LOAD_DESTINATION_SUCCESS',
    ...
    FETCH_DESTINATION_FAILURE = '@destination/LOAD_DESTINATION_FAILURE',
    ...
    FETCH_DESTINATION_REQUEST = '@destination/LOAD_DESTINATION_REQUEST',
}

...
export class FilterButton extends React.Component<ButtonProps, FilterButtonState> {
    public readonly state: Readonly<FilterButtonState> = {disabled: false, selected: false};
    ...
    render() {
        return (
            <button className={(this.state.selected) ? "contextFilterButtons active" : "contextFilterButtons"}
